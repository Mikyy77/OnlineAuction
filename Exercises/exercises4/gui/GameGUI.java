...
public class GameGUI extends Application {
	...
	private Button deleteText = new Button("Delete Text");
	...
	private EnergyOfKnights knightEnergy;
	...
	public void start(Stage mainWindow) {
		...
		pane.getChildren().add(deleteText);
...
*/
 		...
 		knightEnergy = new EnergyOfKnights(game);
 		game.followClash(knightEnergy);
		pane.getChildren().add(knightEnergy);
